                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            <div class="ps-product__thumbnail">
                                                ...
                                                <a class="ps-product__image" href="" style="width: 100%;height: 150px;">
                                                    <figure>
                                                        <img src="{{ !empty($latest_product->image) ? url('storage/' . $latest_product->image) : 'https://ui-avatars.com/api/?name=' . urlencode($latest_product->name) }}" alt="alt" />

                                                        <img
                                                            src="{{ !empty($latest_product->image) ? url('storage/' . $latest_product->image) : 'https://ui-avatars.com/api/?name=' . urlencode($latest_product->name) }}" alt="alt" />
                                                ...
                                                <div class="ps-product__badge">
                                                    <div class="ps-badge ps-badge--sold">New</div>
                                                </div>

                                            </div>
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="">{{ $latest_product->name }}</a>
                                                </h5>

                                                <div class="ps-product__meta">

                                                    <span class="ps-product__price sale">Tk {{ $latest_product->selling_price }}</span>
                                                        @if ($latest_product->discount_price == null)

                                                        @else
                                                        <span class="ps-product__del">Tk {{ $latest_product->discount_price }}</span>
                                                        @endif
                                                </div>
                        ...
                        <div class="ps-section__product">
                            <div class="ps-product ps-product--standard">
                                ...
                                <div class="ps-product__content">
                                    ...
                                    <div class="ps-product__meta"><span class="ps-product__price sale">$65.39</span><span
                            ...
                            <div class="ps-product ps-product--standard">
                                ...
                                <div class="ps-product__content">
                                    <h5 class="ps-product__title"><a href="product1.html">3-Ply Ear-Loop Disposable Blue
                                            Face Mask</a></h5>
                                    <div class="ps-product__meta"><span class="ps-product__price sale">$32.39</span><span
                            ...
                            <div class="ps-product ps-product--standard">
                                ...
                                <div class="ps-product__content">
                                    <h5 class="ps-product__title"><a href="product1.html">Disposable Face Mask for
                                            Unisex</a></h5>
                                    <div class="ps-product__meta"><span class="ps-product__price sale">$20.39</span><span
                            ...
                            <div class="ps-product ps-product--standard">
                                ...
                                <div class="ps-product__content">
                                    <h5 class="ps-product__title"><a href="product1.html">Generic Stethoscope Hearing
                                            Heartbeat Tool</a></h5>
                                    <div class="ps-product__meta"><span class="ps-product__price sale">$53.75</span><span
