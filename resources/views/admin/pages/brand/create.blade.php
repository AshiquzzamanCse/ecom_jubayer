<x-admin-app-layout :title="'Category Create'">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.brand.index') }}" class="btn btn-dark rounded-0 px-3">Back To List
                    </a>
                </div>
            </div>
        </div>
        ...
        <h6 class="mb-0 text-uppercase">Create Brand In Site</h6>
        <hr />
                ...
                <form action="{{ route('admin.brand.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-lg-3 mb-3">
                            ...
                            <input type="text" class="form-control" required placeholder="Brand Name" name="name"
                                value="{{ old('name') }}">
                        </div>
