<x-admin-app-layout :title="'SubCategory Edit'">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.subcategory.index') }}" class="btn btn-dark rounded-0 px-3">Back To List</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->

        <h6 class="mb-0 text-uppercase">Edit SubCategory In Site</h6>
        <hr />

        <div class="card">
            <div class="card-body">

                <form action="{{ route('admin.subcategory.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-lg-4 mb-3">
                            ...
                            <select name="category_id" required class="form-select" id="">
                        ...
                        <div class="col-6 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="SubCategory Name" name="name" value="{{ old('name', $item->name) }}">
                        </div>
