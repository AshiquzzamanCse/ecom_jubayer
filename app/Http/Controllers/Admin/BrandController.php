...
class BrandController extends Controller
{
   /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.brand.index')->with('success', 'Data Inserted Successfully!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.pages.brand.edit', compact('item'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.brand.index')->with('success', 'Data Updated Successfully!!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.brand.index')->with('success', 'Data Delete Successfully!!');
    }
}
